...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST["nameProducto"]) && isset($_POST["cantidad"]) && isset($_POST["lote"]) && isset($_POST["fecha"]) && isset($_POST["desc"]) && isset($_POST["categoria"])) {
    ...
    $sql = "INSERT INTO productos (nombre_producto,cantidad,lote,categoria,fecha_caducidad,desc_producto) VALUES (:nombre, :cantidad, :lote, :categoria, :fecha, :desc)";
...
<body class="flex">
    ...
    <main class="w-5/6 h-screen  bg-slate-700 flex flex-col justify-center items-center">
        ...
        <form method="post" action="registrarProducto.php" class="w-5/6 mx-auto bg-slate-900 p-10 mt-20 rounded-3xl">
            <h2 class="text-white mb-5">Registrar Producto</h2>
            <div class="relative z-0 w-full mb-5 group">
                <input name="nameProducto" type="text" name="floating_email" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
