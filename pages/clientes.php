...
<body class="flex">
    ...
    <main class="w-5/6 h-screen  bg-slate-700 flex flex-col justify-center items-center">
        ...
        <form class="w-2/3 my-10  flex ">
            ...
            <div class="relative w-2/3">
                ...
                <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar Clientea" required />
                <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
            </div>

            <a href="./registrarCliente.php" class="w-15 mx-10 text-white  flex items-center justify-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Agregar</a>
        </form>
    ...
    <script>
        ...
        function editar(idTrabajo) {
            window.location.href = 'editarCliente.php?id=' + idTrabajo;
        }

        function remove(idTrabajo) {
            window.location.href = 'deleteCliente.php?id=' + idTrabajo;
        }
