...
<body class="flex">
    <nav id="contMenu" class="w-full h-24 min-w-96 bg-slate-900 flex justify-around items-center px-10 shadow-2xl fixed">
        ...
        <div class="w-1/3 flex justify-start items-center ">
            <h1 class="w-full text-center text-3xl text-white"> Proveedores</h1>
        </div>
    ...
    <nav class="w-1/6 h-screen bg-slate-300 shadow-2xl flex flex-col justify-center items-center">
        <ul class="w-full">
            ...
            <li class="w-full flex">
                <a href="./proveedores.php" class="w-full p-5 bg-slate-500 hover:bg-slate-400 flex items-center gap-4" href="#">
                    <svg class="w-10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
    ...
    <main class="w-5/6 h-screen  bg-slate-700 flex flex-col justify-center items-center">
        ...
        <form class="w-2/3 my-10  flex ">
            ...
            <div class="relative w-2/3">
                ...
                <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar Proveedores" required />
                <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
            </div>

            <a href="./registrarProveedores.php" class="w-15 mx-10 text-white  flex items-center justify-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Agregar</a>
        </form>
    ...
    <script>
        ...
        function editar(idTrabajo) {
            window.location.href = 'editarProveedor.php?id=' + idTrabajo;
        }

        function remove(idTrabajo) {
            window.location.href = 'deleteProveedor.php?id=' + idTrabajo;
        }
