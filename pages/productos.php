...
<body class="flex">
    <nav id="contMenu" class="w-full h-24 min-w-96 bg-slate-900 flex justify-around items-center px-10 shadow-2xl fixed">
        ...
        <div class="w-1/3 flex justify-start items-center ">
            <h1 class="w-full text-center text-3xl text-white"> Productos</h1>
        </div>
    ...
    <nav class="w-1/6 h-screen bg-slate-300 shadow-2xl flex flex-col justify-center items-center">
        <ul class="w-full">
            <li class="w-full flex">
                <a href="./productos.php" class="w-full p-5 bg-slate-400 hover:bg-slate-500 flex items-center gap-4">
    ...
    <main class="w-5/6 h-screen  bg-slate-700 flex flex-col justify-center items-center">
        ...
        <form class="w-2/3 my-10  flex ">
            ...
            <a href="./registrarProducto.php" class="w-15 mx-10 text-white  flex items-center justify-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Agregar</a>
        </form>
    ...
    <script>
        ...
        function editar(idTrabajo) {
            window.location.href = 'editar.php?id=' + idTrabajo;
        }

        function remove(idTrabajo) {
            window.location.href = 'delete.php?id=' + idTrabajo;
        }
