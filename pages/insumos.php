...
<body class="flex">
    <nav id="contMenu" class="w-full h-24 min-w-96 bg-slate-900 flex justify-around items-center px-10 shadow-2xl fixed">
        ...
        <div class="w-1/3 flex justify-start items-center ">
            <h1 class="w-full text-center text-3xl text-white"> Insumos</h1>
        </div>
    ...
    <nav class="w-1/6 h-screen bg-slate-300 shadow-2xl flex flex-col justify-center items-center">
        <ul class="w-full">
            ...
            <li class="w-full flex">
                <a href="./clientes.php" class="w-full p-5  hover:bg-slate-500 flex items-center gap-4" href="#">
            ...
            <li class="w-full flex">
                <a href="./insumos.php" class="w-full p-5 bg-slate-400 hover:bg-slate-400 flex items-center gap-4" href="#">
    ...
    <main class="w-5/6 h-screen  bg-slate-700 flex flex-col justify-center items-center">
        ...
        <form class="w-2/3 my-10  flex ">
            ...
            <div class="relative w-2/3">
                ...
                <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar Clientes" required />
                <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
            </div>

            <a href="./registrarInsumo.php" class="w-15 mx-10 text-white  flex items-center justify-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Agregar</a>
        </form>
            ...
            <tbody>
                ...
                ?>
                        ...
                        <tr class="bg-white border-b dark:bg-slate-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <?php echo $row['fecha_caducidad'] ?>
                            </td>
                            <td class="px-6 py-4 flex justify-center items-center gap-4">
                                <button type="submit" onclick="remove(<?php echo $row['id']; ?>)" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-blue-800">Eliminar</button>
                                <button type="submit" onclick="editar(<?php echo $row['id']; ?>)" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Editar</button>
                            </td>
                        </tr>
                <?php
                    }
    ...
    <script>
        ...
        function editar(idTrabajo) {
            window.location.href = 'editarInsumo.php?id=' + idTrabajo;
        }

        function remove(idTrabajo) {
            window.location.href = 'deleteInsumo.php?id=' + idTrabajo;
        }
