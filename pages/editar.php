...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST["nameProducto"]) && isset($_POST["cantidad"]) && isset($_POST["lote"]) && isset($_POST["fecha"]) && isset($_POST["desc"]) && isset($_POST["categoria"])) {
...
<body class="flex">
    ...
    <nav class="w-1/6 h-screen bg-slate-300 shadow-2xl flex flex-col justify-center items-center">
        <ul class="w-full">
            <li class="w-full flex">
                <a class="w-full p-5 bg-slate-400 hover:bg-slate-500 flex items-center gap-4">
    ...
    <main class="w-5/6 h-screen  bg-slate-700 flex flex-col justify-center items-center">
        ...
        $consulta = 'SELECT * FROM productos WHERE id =' . $idToUpdate;
        ...
        ?>
            <form method="POST" action="" class="w-5/6 mx-auto bg-slate-900 p-10 mt-20 rounded-3xl">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="<?php echo $row['nombre_producto'] ?>" name="nameProducto" type="text" name="floating_email" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
